...
# throughput_node_0_values = np.reshape(np.array(throughput_node_0_values), (len(par_scheduling_policy_values), len(par_buffer_discipline_values),  len(par_who_has_buffer_values), len(par_max_buffering_time_values), len(par_seed_values)))
...
# throughput_node_1_values = np.reshape(np.array(throughput_node_1_values), (len(par_scheduling_policy_values), len(par_buffer_discipline_values),  len(par_who_has_buffer_values), len(par_max_buffering_time_values), len(par_seed_values)))
...
# throughput_channel_total_values = np.reshape(np.array(throughput_channel_total_values), (len(par_scheduling_policy_values), len(par_buffer_discipline_values),  len(par_who_has_buffer_values), len(par_max_buffering_time_values), len(par_seed_values)))
...
for who_has_buffer_index, who_has_buffer in enumerate(par_who_has_buffer_values):
    for buffer_discipline_index, buffer_discipline in enumerate(par_buffer_discipline_values):
        ...
        for scheduling_policy_index, scheduling_policy in enumerate(par_scheduling_policy_values):
            ...
            # ax2.plot(par_max_buffering_time_values, throughput_node_0_values_average[scheduling_policy_index, buffer_discipline_index, who_has_buffer_index, :], label="Throughput of node 0, Scheduling policy: "+scheduling_policy, linestyle='dashed')
            # ax2.plot(par_max_buffering_time_values, throughput_node_1_values_average[scheduling_policy_index, buffer_discipline_index, who_has_buffer_index, :], label="Throughput of node 1, Scheduling policy: "+scheduling_policy, linestyle='dashed')
            # ax2.plot(par_max_buffering_time_values, throughput_channel_total_values_average[scheduling_policy_index, buffer_discipline_index, who_has_buffer_index, :], label="Total throughput, Scheduling policy: "+scheduling_policy, linestyle=linestyles[1], color=color, alpha=1)
